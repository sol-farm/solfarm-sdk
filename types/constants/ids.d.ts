export const TOKEN_PROGRAM_ID: anchor.web3.PublicKey;
export const MEMO_PROGRAM_ID: anchor.web3.PublicKey;
...
export const LENDING_PROGRAM_ID: anchor.web3.PublicKey;
export const QUARRY_MINE_PROGRAM: anchor.web3.PublicKey;
export const SUNNY_QUARRY_PROGRAM: anchor.web3.PublicKey;
export const AQUAFARM_PROGRAM_ID: anchor.web3.PublicKey;
export const ORCA_SWAP_PROGRAM_ID: anchor.web3.PublicKey;
